...
/**
 * The income/rent beat now runs inside the chat sheet (OnboardingBeatHost,
 * EssentialsBeatBlock). This route is retained only as a redirect so stale
 * links / mid-flow refreshes resolve correctly — resumeRoute sends in-sheet
 * steps to /office.
 */

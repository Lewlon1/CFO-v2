-- Session 32 (A) — Layer 4: Conversational signals extracted from chat
-- Pattern matching (regex) first pass; Haiku LLM fallback for ambiguous cases.
-- Hooked into /api/chat via after() (fire-and-forget) when isLayeredReadEnabled().
